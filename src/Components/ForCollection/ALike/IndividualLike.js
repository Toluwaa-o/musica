...
export default function IndLike({title, artist, cover, src, duration}) {
    const dispatch = useDispatch()
    const newSong = () => {
        dispatch(playActions.playAudio({title, artist, cover, src, duration}))
      }

  return (
    <div onClick={newSong} className='ind-like'>
                <img src={cover} />
